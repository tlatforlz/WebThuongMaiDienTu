...
public class NHANVIEN {
    ...
    private int tb_loainhanvien_ID;
    private String tb_loainhanvien_MaLoaiNhanVien;

    public NHANVIEN() {
    }

    public NHANVIEN(int ID, String MaNhanVien, String TaiKhoan, String MatKhau, String MatKhauCapHai, String Email, String DiaChi, String SoDienThoai, Date NgaySinh, int tb_loainhanvien_ID, String tb_loainhanvien_MaLoaiNhanVien) {
        this.ID = ID;
        ...
        this.tb_loainhanvien_ID = tb_loainhanvien_ID;
    ...
    public int getTb_loainhanvien_ID() {
        return tb_loainhanvien_ID;
    }

    public void setTb_loainhanvien_ID(int tb_loainhanvien_ID) {
        this.tb_loainhanvien_ID = tb_loainhanvien_ID;
    }
