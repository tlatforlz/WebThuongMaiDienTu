...
<html>
    ...
    <body>
        ...
        <div class="logo_products">
            <div class="container">
                <div class="w3ls_logo_products_left">
                    <h1><a href="products.jsp"><span>Grocery</span> Store</a></h1>
                </div>
        ...
        <div class="products-breadcrumb">
            <div class="container">
                <ul>
                    <li><i class="fa fa-home" aria-hidden="true"></i><a href="index.jsp.html">Home</a><span>|</span></li>
                    <li>Branded Foods</li>
                </ul>
            </div>
        </div>
                                        ...
                                        <figure>
                                            <div class="snipcart-item block">
                                                <div class="snipcart-thumb">
                                                    <a href="single.html"><img src="<%=sp.getHinhAnh()%>" alt=" " class="img-responsive" /></a>
                                                    ...
                                                    <%
                                                        if (sp.getGiamGia() != 0) {
                                                    %> 
                                                    <h4 class="product-have-sale">
                                                        <%=sp.getGiamGiaString()%>
                                                        <span >
                                                            <%=sp.getDonGiaString()%>
                                                        </span>
                                                    </h4><% } else {
                                                    %> <h4><%=sp.getDonGiaString()%></h4>
                                                    <%
                                                        }
                                                    %>
                                                ...
                                                <div class="snipcart-details">
                                                    <form action="#" method="post">
                                                        <fieldset>
                                                            ...
                                                            <input type="hidden" name="item_name" value="<%=sp.getTenSanPham()%>" />
                                                            <input type="hidden" name="amount" value="<%=sp.getDonGia()%>" />
                                                            <%
                                                                if (sp.getGiamGia() != 0) {
                                                            %><input type="hidden" name="discount_amount" value="<%=sp.getDonGia() - sp.getGiamGia()%>" /> <%
                                                            } else {
